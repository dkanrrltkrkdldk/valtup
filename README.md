...
룰렛 참여:                                                                                                                                                                                                                          
요청 → 중복체크 → 예산Lock → 예산차감 → 참여기록 → 포인트지급 → 응답

상품 구매:                                                                                                                                                                                                                          
요청 → 상품Lock → 재고확인 → 잔액확인 → FIFO차감 → 재고차감 → 주문생성 → 응답

- 확장 고려사항    
 현재 (단일 서버)          확장 시                                                                                                                                                                                                   
 ─────────────────────────────────────                                                                                                                                                                                               
 Session (Memory)    →    Redis Session                                                                                                                                                                                              
 Pessimistic Lock    →    Distributed Lock (Redisson)                                                                                                                                                                                
 단일 DB             →    Read Replica                                                                                                                                                                                               
 Cron Scheduler      →    분산 스케줄러 (ShedLock) 
